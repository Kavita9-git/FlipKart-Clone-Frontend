import { StyleSheet, Text, View, FlatList, NativeSyntheticEvent, NativeScrollEvent, Platform, ActivityIndicator } from 'react-native'
...
const MainList: FC<{ scrollYGlobal: any }> = ({ scrollYGlobal }) => {
    ...
    const renderItem = ({ item }: any) => {
        const Component = SectionComponent[item?.type];
